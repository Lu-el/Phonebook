...
},{"./createElemenst":2,"./serviceStorage.js":4}],2:[function(require,module,exports){
'use strict';
...
const createFooter = () => {
  ...
  footer.textContent = `Все права защищены ©Максим`;
  return footer;
};
...
},{"./createElemenst":2,"./serviceStorage.js":4}],4:[function(require,module,exports){
'use strict';
...
},{"./modules/control":1,"./modules/render.js":3}]},{},[5]);
